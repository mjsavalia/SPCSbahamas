...
st.markdown("""
    ...
    /* Clean high-contrast white background for the sidebar menu */
    ...
    /* 📱 HIGH-VISIBILITY MENU NOTICE INSTRUCTION BANNER 📱 */
    .mobile-instruction-banner {
        background-color: #FFFFFF;
        border: 2.5px solid #0055D4;
        padding: 14px;
        border-radius: 10px;
        text-align: center;
        margin-bottom: 20px;
        box-shadow: 0 4px 12px rgba(0, 85, 212, 0.15);
    }
...
with st.sidebar:
    ...
    st.markdown("<p style='font-size:13px; color:#555555;'>Select any option below to view details instantly.</p>", unsafe_allow_html=True)
    st.markdown("---")
...
# 📱 "CLICK HERE" CALL-TO-ACTION MENUBAR GUIDE
st.markdown("""
<div class="mobile-instruction-banner">
    <span style="font-size: 15px; font-weight: 700; color: #0033AA;">👉 CLICK HERE / TAP THE TOP LEFT (☰) MENU BUTTON</span>
    <p style="margin: 5px 0 0 0; font-size: 13px; color: #374151;">To access all interactive daily schedule buttons, policies, and the evening portal!</p>
</div>
""", unsafe_allow_html=True)
...
<div class="social-card">
    ...
    <a href="https://www.facebook.com/groups/769538356499119" target="_blank" class="social-link">Facebook Group</a> [cite: 44] | 
    <a href="https://www.instagram.com/spcs_legacy_in_motion/" target="_blank" class="social-link">Instagram</a> [cite: 44]
</div>
""", unsafe_allow_html=True)
...
# 9. EMERGENCY PROTOCOL
    ...
    <div class="policy-box">
        <strong style="color: #0033AA;">📇 What is a SeaPass Card? [cite: 22]</strong><br>
    ...
    * **Missing the Ship:** If you are left behind or lost at a port, immediately find the **Local Port Agent** contact info[cite: 32]. It is printed at the bottom of the daily paper *Cruise Compass* and listed in your Royal Caribbean App on port days[cite: 33]. **Take a screenshot before leaving the ship.**  The port agent is the only person who can help you clear customs or catch up to the ship.
    """)
...
# 10. DAILY DINNER UPDATE
    ...
    <div class="dinner-box">
        <strong>📋 Evening Dining Schedule[cite: 37]:</strong><br>
        • <strong>Time:</strong> 5:00 PM Sharp — Official Group Dinner booked (Daily) [cite: 38, 40]<br>
        • <strong>Location:</strong> Main Dining Room (Early seating selected) [cite: 39, 41]<br>
