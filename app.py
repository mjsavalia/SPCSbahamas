...
# --- TRACK NAVIGATION STATE (MULTIPAGE CONTROL) ---
...
<div class="ocean-header-panel">
    ...
    <div class="subtitle">Bahamas - Trip Itinerary</div>
</div>
""", unsafe_allow_html=True)

# Fixed Top Social Media Handles (Instagram only)
st.markdown("""
<div class="social-card">
    <span style="font-weight: 600; color: #000000;">🔗 Official Community Page:</span>
